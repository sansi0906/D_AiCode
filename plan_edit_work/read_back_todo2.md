...
以下为平台主体（单一主体）从营业执照确认后到小程序发布上架的完整待办事项，主线事项按执行顺序编号，支线事项可并行。全部业务资质、证照均以该平台主体名义办理。
...
全部业务与证照均挂靠平台主体单一主体：增值电信、食品、装修施工资质按各自业务分别办理，互不豁免。
